...
class Database:
    ...
    async def get_cart_products(self, user_id):
        ...
        return await self.pool.fetch(
            ...
            JOIN mahsulotlar p ON oi.product_id=p.id
            WHERE o.user_id=$1 AND o.order_status='cart'
            """,
            user_id
        )
    
    async def mahsulot_qoshish(self,name,price,description):
        query="""
        insert into mahsulotlar(name,price,description) values($1,$2,$3);
        """
