...
def sotib_olish_kb(call):
     return InlineKeyboardMarkup(
          inline_keyboard=[
               [InlineKeyboardButton(text="Sotib olish",callback_data="sotib_olish"),InlineKeyboardButton(text="Savatga qo'shish",callback_data="savatga_qoshish")]
          ]
     )
