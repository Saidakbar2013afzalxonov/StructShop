...
async def sotib_olish(call:CallbackQuery):
    await call.message.answer(f"Mahsulotni sotib olasizmi yoki savatga qo'shasizmi?",reply_markup=sotib_olish_kb(call))
    await call.answer()